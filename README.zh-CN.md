...
- **6 大 AI Agent** — Claude Code、Codex、Cursor Agent、Qoder CLI、Gemini CLI、OpenCode，按需选用，也可以同时使用
...
| Platform | QQ (通过 NapCat/OneBot) | ✅ WebSocket，无需公网 IP |
...
- **OpenCode**: [OpenCode](https://github.com/opencode-ai/opencode) 已安装（`opencode --version` 验证）
